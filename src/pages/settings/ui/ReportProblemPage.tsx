    ...
    <div className="flex-grow overflow-y-auto min-h-full">
      <div className="p-6 max-w-lg mx-auto space-y-8 flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 w-full">
          <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-900/50 rounded-xl flex items-start gap-3 text-sm text-blue-800 dark:text-blue-400 mb-2">
            <AlertCircle className="w-5 h-5 shrink-0 mt-0.5" />
            <p>{t('reportPage.testEnded')}</p>
          </div>
          {!user && (
